...
// Client for IC-WiFi system running on Aruba Networks
public class ArubaIcClient implements LoginClient {

    private static final String TAG = "ArubaIcClient";
    ...
    public ArubaIcClient(Context context) throws IOException {
        mHttpClient = Utils.createHttpClient(true, Utils.getRawResource(context, R.raw.ic_wifi));
    }
